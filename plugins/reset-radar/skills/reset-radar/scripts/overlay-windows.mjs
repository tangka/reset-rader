...
export async function runWindowsOverlay({ environment = process.env, signal, sessionId = randomUUID(),
  ...
  if (process.platform !== 'win32') throw new Error('The native radar card is available on Windows only.');
